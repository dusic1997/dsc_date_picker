...
/// [showDscDatePicker], which will create a dialog that uses this as well as
/// provides a text entry option.
///
/// See also:
///
///  * [showDscDatePicker], which creates a Dialog that contains a
    ...
    while (day < daysInMonth) {
      ...
      if (day < 1) {
        ...
        dayItems.add(Column(
          children: [
            dayWidget,
            widget.dayExtraLabelBuilder?.call(dayToBuild) ?? SizedBox()
          ],
        ));
      }
    }
...
/// [CalendarDatePicker], or [showDscDatePicker] which create full date pickers.
///
/// See also:
///
...
///    interface.
///
///  * [showDscDatePicker], which shows a dialog containing a Material Design
///    date picker.
///
