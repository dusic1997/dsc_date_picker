...
///
Future<DateTime?> showDscDatePicker(
    ...
    Offset? anchorPoint,
    Widget Function(DateTime)? dayExtraLabelBuilder}) async {
  assert(context != null);
  ...
  Widget dialog = DatePickerDialog(
    ...
    dayExtraLabelBuilder: dayExtraLabelBuilder,
  );
...
///
/// It is used internally by [showDscDatePicker] or can be directly pushed
/// onto the [Navigator] stack to enable state restoration. See
/// [showDscDatePicker] for a state restoration app example.
///
/// See also:
///
///  * [showDscDatePicker], which is a way to display the date picker.
class DatePickerDialog extends StatefulWidget {
  ...
  final Widget Function(DateTime)? dayExtraLabelBuilder;
  ...
  Widget build(BuildContext context) {
    ...
    CalendarDatePicker calendarDatePicker() {
      return CalendarDatePicker(
        dayExtraLabelBuilder: widget.dayExtraLabelBuilder,
...
/// See also:
///
///  * [showDscDatePicker], which shows a Material Design date picker used to
